...
class ProyectsControllerTest < ActionController::TestCase
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post :create, proyect: { begindate: @proyect.begindate, description: @proyect.description, enddate: @proyect.enddate, name: @proyect.name }
    end
  ...
  test "should update proyect" do
    patch :update, id: @proyect, proyect: { begindate: @proyect.begindate, description: @proyect.description, enddate: @proyect.enddate, name: @proyect.name }
    assert_redirected_to proyect_path(assigns(:proyect))
  end
